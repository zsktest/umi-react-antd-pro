    ...
    },
    {
      ...
      render:(text: string, record: DataType) => (
        <div className={styles.action}>
          <a href="TypeScript:;" onClick={()=>history.push(`/account/detail?userUuid=${record.userUuid}`)}>查看</a>
          <Dropdown overlay={
  ...
  return (
    ...
    <div className={styles.account}>
      <div className={styles.account_title}>
        ...
        <div className={styles.account_name}>
          <Input placeholder="支持账号或姓名模糊查询" style={{width: 200}} onChange={(e:any)=>setKeywords(e.target.value)} suffix={<SearchOutlined onClick={()=>getaccountUser({page: current, size, expiredStatus: sortOrder, key: keywords})}/>}/>
        </div>
